...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'RECREATED BY AMAN'
    else
        figlet TBomb
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Moded By \e[1;32mAMAN \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border AMAN
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/TerrorHacksXD \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/TechGyan With Aman \e[0m"
    echo " "
